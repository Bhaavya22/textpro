...
Label(root1, text="sign-in", font= " ar 15 bold").place(x=10, y=10)
Label(root1,  text = "Username").place(x = 40,  y = 60)  

Label(root1,  text = "Password").place(x = 40, y = 90)  
Label(root1,  text = "",textvariable=STATUS).place(x = 40, y = 120)  
 
#confirm_pwd = Label(root, text="confirm_password").place(x=40, y=120)

Label(root1, text="email").place(x =40, y=120)
...
Entry(root1, width=30, textvariable=pwd).place(x=110,y=90)
Entry(root1 ,width=30,textvariable=email_val).place(x=110,y=120)
